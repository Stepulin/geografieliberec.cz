...
p = figure(title = 'Celkový počet obyvatel v roce 2019', plot_height = 600 , plot_width = 950, toolbar_location = "right")
...
from bokeh.models import Slider, HoverTool, formatters, Axis, BasicTickFormatter, WheelZoomTool
...
p = figure(title = 'Celkový počet obyvatel v roce 2019', plot_height = 600 , plot_width = 950, toolbar_location = "right", tools = [hover])
