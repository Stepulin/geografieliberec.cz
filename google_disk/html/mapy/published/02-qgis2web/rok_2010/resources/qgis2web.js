...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
         maxZoom: 6, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:4326',
            extent: [-180.000000, -55.918504, 180.000000, 83.634101],
            units: 'degrees'})
    })
});
...
map.getView().fit([-180.000000, -55.918504, 180.000000, 83.634101], map.getSize());
