...
p = figure(title = 'Střední délka života u žen v roce X', plot_height = 720, plot_width = 1280, toolbar_location = "right")
p.xgrid.grid_line_color = None
p.ygrid.grid_line_color = None
p.patches('xs','ys', source = geosource,fill_color = {'field' : 'str_dlk_ziv_Z', 'transform' : color_mapper}, line_color = 'black', line_width = 0.25, fill_alpha = 1)
...
hover = HoverTool(tooltips = [('Stát','@country'),('Střední délka života - ŽENY', '@str_dlk_ziv_Z')])
p = figure(title = 'Střední délka života u žen v roce X', plot_height = 720, plot_width = 1280, toolbar_location = "right", tools = [hover, ResetTool(), BoxSelectTool(), PanTool(), SaveTool()])
...
def update_plot(attr, old, new):
    ...
    p.title.text = 'Střední délka života u žen v roce %d' %yr
