...
p = figure(title = 'Porodnost v roce X', plot_height = 720, plot_width = 1280, toolbar_location = "right")
...
p = figure(title = 'Porodnost v roce X', plot_height = 720, plot_width = 1280, toolbar_location = "right", tools = [hover, ResetTool(), BoxSelectTool(), PanTool(), SaveTool()])
