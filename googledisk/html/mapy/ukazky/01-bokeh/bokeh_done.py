...
p = figure(title = 'Celkový počet obyvatel v roce 2019', plot_height = 600 , plot_width = 950, toolbar_location = "right", tools = [hover, ResetTool(), BoxSelectTool(), PanTool(), SaveTool()])
